...
\begin{quote}
    ...
    \begin{quote}
        ...
        Nehmen Sie zusätzlich zu der Regelgröÿe auch die Stellgröße $r_i$ des Regelkreises auf.
    ...
    \subsection{Rregler mit schlechten Störeigenschaften}
    Untersuchen Sie nun den Regelkreis mit den zuerst bestimmten Parametern aus Aufgabe
    \ref{2d}. Nehmen Sie die Störsprungantwort des Systems auf. Wie äuÿert sich das unbefriedigende Störverhalten in der Praxis?
